# final_map.py - Скрипт для создания уникальной топологии и визуализации
from map_builder import build_full_map
from pprint import pprint
# from draw_network_graph import draw_topology # Предполагается, что этот модуль существует

def clean_topology(topology_dict):
    """
...
if __name__ == "__main__":
    ...
    unique_topology = clean_topology(topology)
